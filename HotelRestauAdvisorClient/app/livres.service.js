...
var LivresService = (function () {
    ...
    LivresService.prototype.RecupererLivres = function () {
        var livres = this.http.get((this.UrlWebApi + '/Livres'), { headers: this.getHeaders() }).map(function (response) { return response.json(); });
        return livres;
    };
    LivresService.prototype.ChercherParId = function (id) {
        return this.http.get((this.UrlWebApi + '/Livre/' + id), { headers: this.getHeaders() }).map(function (response) { return response.json(); });
    };
    LivresService.prototype.ChercherParCategorie = function (categorie) {
        return this.http.get((this.UrlWebApi + '/Livres/' + categorie), { headers: this.getHeaders() }).map(function (response) { return response.json(); });
    };
